...
QUEUE_NAME = os.getenv("FACTOR_RESULT_QUEUE_NAME", "${factor_result_queue_name}")
...
response = sec.get_secret_value(SecretId=os.getenv("RDS_SECRET_NAME", "${rds_secret_name}"))
